...
(เช่น JWT_EXPIRE_MINUTES=480 ใน .env จะกลายเป็น int 480 ใน Python)
"""
...
class Settings(BaseSettings):
    ...
    # ------------------------------------------------------------ HR Employee API (รูปโปรไฟล์)
    # ใช้ดึง picture_url + ชื่อพนักงานจากอีเมล มาแสดงเป็น Avatar บนแถบบน
    # ค่า default ใส่ไว้ให้ใช้งานได้ทันที แต่ควรย้ายไปไว้ใน .env เพื่อไม่ให้รหัสอยู่ในโค้ด
    EMP_API_USERNAME: str = "AuthorizeWorking"
    EMP_API_PASSWORD: str = "WorkingApi2026*"
    EMP_TOKEN_URL: str = "https://p701apsi01-la02skc.azurewebsites.net/skcapi/token"
    EMP_SEARCH_URL: str = "https://p701apsi01-la01skc.azurewebsites.net/skcapi/empsearch"
